...
const DECLARED_CSP = "script-src 'self' 'unsafe-eval'; object-src 'self'";
...
(async () => {
  await beacon("/alive?stage=start&variant=" + encodeURIComponent("ext-unsafe-eval"));
