...
const DECLARED_CSP = "script-src 'self' 'wasm-eval'; object-src 'self'";
...
(async () => {
  await beacon("/alive?stage=start&variant=" + encodeURIComponent("ext-wasm-eval"));
