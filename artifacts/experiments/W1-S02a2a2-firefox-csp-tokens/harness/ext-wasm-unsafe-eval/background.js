...
const DECLARED_CSP = "script-src 'self' 'wasm-unsafe-eval'; object-src 'self'";
...
(async () => {
  await beacon("/alive?stage=start&variant=" + encodeURIComponent("ext-wasm-unsafe-eval"));
  ...
  ep.variant = "ext-wasm-unsafe-eval";
  ...
  wr.variant = "ext-wasm-unsafe-eval";
