...
| **Explicitly not done** | Not corrected in place — the claims are introduced by unmerged PR #1, so correcting them now would conflict with it. Raised on PR #1 as review findings instead. |
