...
> with `augmentation: "none"` on one resampler), now joined by **compression robustness** —
> the detector loses **8–9% of detections at JPEG q62** against the lossless frame — and
> adoption items 11 and 14, acceptable metrics and usable grounding. None of them is touched
> by QG-03b or QG-03b-2.
